...
class UzumException extends Exception
{
    /**
     * @param string $message
     * @param string $errorCode
     */
    public function __construct(string $message, public readonly string $errorCode = '10000')
    {
        parent::__construct($message);
    }

    /**
     * Convert exception to Uzum error response.
     *
